...
- `blender-with-packages` has been removed in favor of `blender.withPackages`. It can be used as `blender.withPackages(ps: [ps.bpycv])`, similar to `python3.withPackages`.
